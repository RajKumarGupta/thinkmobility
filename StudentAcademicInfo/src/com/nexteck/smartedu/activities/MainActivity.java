...
import com.nexteck.smartedu.adapter.NavDrawerListAdapter;
import com.nexteck.smartedu.model.NavDrawerItem;
...
public class MainActivity extends Activity {
	...
	private void displayView(int position) {
		...
		case 0:
			...
			Profile profile = (Profile)intent.getSerializableExtra("profileObject");
			Bundle bundle = new Bundle();
			bundle.putSerializable("profile", profile);
			fragment.setArguments(bundle);
			Log.i("Main Activity class", "ProfileFragment class called");*/
			break;
		case 1:
		...
		case 5:
			...
			break;
		case 6:
			fragment = new ExtraactivityFragment();
			break;
		...
		case 15:
				fragment = new ParentsCallFragment();
				break;
